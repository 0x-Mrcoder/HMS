@php
    ...
    $displayName = $patient?->full_name ?? ($user->name ?? 'User');
    $displayEmail = $patient?->email ?? ($user->email ?? '');
    $photo = $patient?->photo_url ?? $user?->photo_url ?? null;
    $photoUrl = $photo
        ...
        <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                ...
                <li class="mx-3 welcome-text">
                    <h3 class="mb-0 fw-bold text-truncate">Welcome back, {{ $displayName }}!</h3>
                </li>
            </ul>
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
