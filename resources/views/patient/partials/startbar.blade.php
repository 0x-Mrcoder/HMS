        ...
        <div class="startbar-collapse" id="patientStartbar" data-simplebar>
            <div class="d-flex flex-column h-100 w-100">
                <ul class="navbar-nav mb-auto w-100">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('patient.portal.dashboard') }}#overview">
                            <i class="iconoir-home-simple menu-icon"></i>
                            <span>Overview</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('patient.portal.dashboard') }}#wallet">
                            <i class="iconoir-wallet menu-icon"></i>
                            <span>Wallet &amp; Funding</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('patient.portal.dashboard') }}#appointments">
                            <i class="iconoir-calendar menu-icon"></i>
                            <span>Visits &amp; Appointments</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('patient.portal.dashboard') }}#medications">
                            <i class="iconoir-pill menu-icon"></i>
                            <span>Prescriptions</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('patient.portal.dashboard') }}#labs">
                            <i class="iconoir-lab menu-icon"></i>
                            <span>Lab Results</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('patient.portal.dashboard') }}#care-notes">
                            <i class="iconoir-heartbeat menu-icon"></i>
                            <span>Care Notes</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('patient.portal.dashboard') }}#profile">
                ...
                <div class="startbar-footer">
                    <div class="card bg-primary-subtle text-center border-0 shadow-none">
                        <div class="card-body">
                            ...
                            <p class="fs-13 text-muted mb-3">Reach our care team 24/7 on +234 800 HMS CARE.</p>
